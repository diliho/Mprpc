...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResponseCode, errorcode_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ResponseCode, errormsg_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponse, code_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponse, friends_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::ResponseCode)},
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 575, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_code()) {
    code_ = new ::fixbug::ResponseCode(*from.code_);
  } else {
    code_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from._internal_has_code()) {
    _internal_mutable_code()->::fixbug::ResponseCode::MergeFrom(from._internal_code());
  }
